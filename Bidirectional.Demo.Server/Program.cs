...
{
    Log.ForContext<Program>().Fatal(ex, "Bidirectional Demo Server exited with an exception");
    throw;
}
finally
{
    Log.ForContext<Program>().Information("Bidirectional Demo Server is shutting down");
    Log.CloseAndFlush();
}
